...
module.exports = appInfo => {
  ...
  // 随机修改任意一个值即可
  config.keys = appInfo.name + '_1547540555445_4004';
  // 签名密匙妥善保管，不可泄露，务必修改
  config.secretkey = 'lantian';
  // 绑定的域名， 务必修改
  config.domain = 'http://localhost:8081'; // 请指定协议
  // 浏览器打开 http://dev.yio.me/alipayId.html 支付宝扫码获取支付宝userid 或者 pc登录支付宝 https://my.alipay.com/portal/i.htm 右键查看网页源代码搜索 userId 得到的值
  config.alipayUserId = '2088812628239610';
  ...
  config.baidu = {
    // 设置APPID/AK/SK
    APP_ID: '18580791',
    API_KEY: 'Tx8o4LMPGGdBO9xkYgGbB7jt',
    SECRET_KEY: 'adZTQfa6syeWB2lj4r6Bx0V7CcpgUiNh',
  };
  // 验证器，请勿修改
  config.valdate = {
